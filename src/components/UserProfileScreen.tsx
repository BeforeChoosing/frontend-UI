          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-4 sm:gap-5">
            ...
            */}
            <button
              ...
              className={`w-full lg:w-44 p-5 rounded-2xl sm:rounded-3xl flex flex-col items-center justify-center text-center gap-2 transition-all cursor-pointer border shrink-0 ${
                activeArchTab === 'cards'
