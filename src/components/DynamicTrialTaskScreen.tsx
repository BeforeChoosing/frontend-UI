      ...
      <div className="mx-auto min-h-[calc(100vh-64px)] max-w-6xl px-4 py-8 sm:px-6">
        <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
            <div><p className="font-mono text-[10px] font-bold text-emerald-700">本次任务 · {task.id}{demoMode ? ' · 演示数据' : ''}</p><h1 className="mt-1 font-serif text-2xl text-stone-900">本次任务表现</h1><p className="mt-2 max-w-3xl text-sm leading-relaxed text-stone-600">{evaluation.summary}</p></div>
