...
- 演示模式：与使用模式共用首页，点击“从一段经历开始”后进入“01 认识自己”的能力提取流程。经历文本、候选能力卡、职业建议、任务材料、五步示例草稿、评价结果和个人档案均已准备，无需输入或上传材料。进入“动手试试”后，三轮能力应用从 0/3 开始，五步真实任务从 0/5 开始，需要现场选牌、提交判断并逐步确认。该模式不调用 Qwen，不写入真实画像，适合现场讲解和界面验收。
